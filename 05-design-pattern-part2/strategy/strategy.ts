...
function run() {
    ...
    const sortStrategy1 = new BubbleSort();
    const context1 = new SortContext(sortStrategy1);
    console.log(context1.sort(list1));

    const list2 = [4, 2, 5, 1, 7, 6, 3];
    const sortStrategy2 = new InsertionSort();
    const context2 = new SortContext(sortStrategy2);
